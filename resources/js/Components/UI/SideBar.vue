<template>
    <div class="flex flex-col justify-between flex-1 -mt-10">
        <nav>
            <Link class="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-md "
            ...
            <Link
                ...
                :href="$useRoute('/saved-destinations')">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span class="mx-4 font-medium">Saved Destinations</span>
            </Link>
