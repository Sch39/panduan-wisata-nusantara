<template>
    ...
    <ul class="mx-5 list-decimal px-5 mt-5">
        ...
        <li class="text-lg do">Icon <a title="united states icons"
                href="https://www.flaticon.com/free-icons/united-states" target="_blank" rel="noopener noreferrer"
                class="underline underline-offset-2">United states icons created by Freepik - Flaticon</a></li>
